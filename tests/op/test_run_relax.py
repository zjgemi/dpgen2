...
from dpgen2.op import RunRelax
...
class DeepPot:
    ...
    def eval(*args, **kwargs):
        ...
        v = np.array([[
            -2.35308634,  0.02806883, -0.31607685,
            0.02806883, -2.29484913, -0.15927731,
            -0.31607685, -0.15927731, -1.31155533]])
        return e, f, v
...
def relax_run(*args, **kwargs):
    ...
    with open("relax_trajs/0", "wb") as f:
        pickle.dump({
            ...
            "stresses": [np.array([
                0.02573293, 0.02483516, 0.02152565,
                -0.00011215, 0.0011876, 0.00021871])],
...
class TestRunRelax(unittest.TestCase):
    def testRunRelax(self):
        ...
        model_devi = np.array([0., 0.1132373 , 0.00632493, 0.04404319, 0.0897801, 0.006415, 0.04564122])
